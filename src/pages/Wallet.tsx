    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-20 pb-16">
        <div className="w-full px-4">
          <motion.div 
            className="bg-gradient-to-r from-cyan-500 to-crypto-accent w-full rounded-lg p-6 mb-4"
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-2 mt-8">
              ...
              <div className="bg-white/10 rounded-lg p-3 text-center flex items-center justify-center">
                <Button size="sm" className="bg-white/20 hover:bg-white/30 text-white text-xs rounded-full px-3 py-1 h-auto">
                  View details
            ...
            <div className="overflow-hidden">
              {cryptoAssets.map((asset, index) => (
                <motion.div 
                  ...
                  className="flex justify-between items-center border-b border-gray-700/10 py-4"
                >
                  <div className="flex items-center">
                    <div className="mr-3 w-8 h-8 flex items-center justify-center rounded-full bg-crypto-accent/10">
