        ...
        <div className="container px-4">
          ...
          >
            <div className="flex items-center mb-4">
              <Link to="/" className="text-foreground/70">
            ...
            <div className="bg-crypto-accent text-white rounded-lg p-4 mb-6 flex justify-between items-center">
            ...
            <div className="space-y-px">
              <div className="bg-gray-100/5 rounded-t-lg">
                <div className="flex justify-between items-center px-4 py-4 border-b border-gray-700/10">
